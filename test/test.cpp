...
void setup() 
{
  ...
  // // Parse the output string to get the execution time for the task
  // const char *task_name = "task";
  // char *start_ptr = strstr(stats_buffer, task_name);
  // if (start_ptr != NULL)
  // {
  //     start_ptr += strlen(task_name) + 1;
  //     unsigned int exec_time = atoi(start_ptr);
  //     printf("Execution time for task %s: %u\n", task_name, exec_time);
  // }
